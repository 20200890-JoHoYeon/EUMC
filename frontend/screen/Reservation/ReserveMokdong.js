import { Linking, Pressable, View, StyleSheet, Image, ImageBackground, ScrollView } from 'react-native';
...
const ReserveMokdong = ({ navigation }) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#fff', position: 'relative' }}>
      <ScrollView contentContainerStyle={{}} style={styles.contentContainer}>
        ...
        <Pressable style={styles.content2} onPress={() => navigation.navigate('ReserveNoticeMokdong')}>
          <Image style={styles.icon1} source={require('../../assets/reservation/ic_mainMenu_guide.png')} />
          <EumcText style={styles.fontStyle1}>진료 예약 전 안내 유의사항</EumcText>
        </Pressable>
        <Pressable style={styles.content2} onPress={() => Linking.openURL('tel:' + MAIN_PHONE('02'))}>
          <Image style={styles.icon1} source={require('../../assets/reservation/ic_mainMenu_phoneCall.png')} />
          <EumcText style={styles.fontStyle1}>전화 예약 {MAIN_PHONE('02')}</EumcText>
        </Pressable>
            ...
            <View style={styles.type01}>
              ...
              <View style={styles.timeMargin}>
                <Image
                  ...
                  source={require('../../assets/reservation/Ic_call.png')}
                />
                <EumcText style={styles.timeFont}>ARS안내 02-2650-5114</EumcText>
              </View>
            </View>
          </View>
        </View>
      ...
      {/*<Pressable style={styles.noticeContainer} onPress={() => navigation.navigate('ReserveNoticeMokdong')}>*/}
